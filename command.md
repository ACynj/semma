python script/run.py -c config/transductive/inference-improved.yaml --dataset CoDExSmall --epochs 0 --bpe null --ckpt /T20030104/ynj/semma/ckpts/semma.pth --gpus [0]
